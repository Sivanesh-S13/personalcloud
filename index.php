...
//Application Title
define('APP_TITLE', 'Personal Cloud');
...
$auth_users = array(
    'admin' => '$2y$10$tzo421LZoTrvDcGOL/y52ejrvA.SJArXSdv9GCQLLwi2WLo56XdTa', //123456
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    ...
                    <h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title">
                            Personal Cloud <?php echo VERSION; ?></a></h3>
                    </p>
...
<form action="" method="post" class="pt-3">
            ...
            <tfoot>
                <tr><?php if (!FM_READONLY): ?>
                    ...
                    <td colspan="<?php echo (!FM_IS_WIN && !$hide_Cols) ? '6' : '4' ?>">
                        <em><?php echo 'Folder is empty' ?></em>
                    </td>
                </tr>
            </tfoot>
            <?php
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank"
                class="float-right text-muted">Personal Cloud <?php echo VERSION; ?></a></div>
        <?php else: ?>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'Personal Cloud<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description"
        content="Web based File Manager in PHP, Manage your files efficiently and easily with Personal Cloud">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                            ...
                            <label class="custom-control-label"
                                for="customRadioInline1"><?php echo lng('File') ?></label>
                        </div>
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Personal Cloud';      $tr['en']['AppTitle']           = 'File Manager';
